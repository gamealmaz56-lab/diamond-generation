...
def update_file(filepath, is_ru):
    ...
    if start_idx != -1:
        ...
        <div class="hero-kicker" style="letter-spacing: .2em; text-transform: uppercase;"><span></span>Системное восстановление</div>
        <h1>УПРАВЛЕНИЕ<br>ЭНЕРГИЕЙ<br><em style="font-size:46px; letter-spacing: -1px; margin-top:14px; display:inline-block;">вместо выгорания</em></h1>
      ...
      '''
                ...
                new_hero = '''<div class="hero-text-col r">
        <div class="hero-kicker" style="letter-spacing: .2em; text-transform: uppercase;"><span></span>Systemic recovery</div>
        <h1>ENERGY<br>MANAGEMENT<br><em style="font-size:46px; letter-spacing: -1px; margin-top:14px; display:inline-block;">instead of burnout</em></h1>
